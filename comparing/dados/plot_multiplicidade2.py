...
axes[1].scatter(range(2,100,2),newton_medias,label='Newton')
axes[1].scatter(range(2,100,2),halley_medias,label="Halley")
...
axes[1].grid()
axes[1].legend()
axes[0].scatter(range(2,100,2),halley_newton,color='g')
